(function () {
	...
	Map.prototype = {
		...
		angular.forEach(data, function (resource) {
			...
			myGeoJSON = resource['geometry']

			marker = L.geoJSON(myGeoJSON, {
			...
			// TODO: do we need to check for valid lat/lng before creating object here?
			// (previous version had it)
			myGeoJSON = { 
			    "type": "Feature", 
			...
			// TODO: Insert new Style  here for occurrences????
			marker = L.geoJSON(myGeoJSON, {
			    //style: function (feature) {
			    //   return feature.properties.style;
			    //},
