(function() {
	...
	function modal(Map) {
		...
		/*
		modal.prototype = Object.create(Map.prototype);

		modal.prototype.addContent = function(data,zoomTo) {
			Map.prototype.addContent.call(this, data, popupContentCallback, zoomTo);
			var _this = this
