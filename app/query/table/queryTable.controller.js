(function () {
    ...
    function QueryTableController($scope, $window, queryResults) {
        ...
        vm.tableColumns = ["institutionCode","collectionCode","basisOfRecord","phylum","class","order","family","genus","species","eventDate","locality","decimalLatitude","decimalLongitude","key"];
        vm.tableData = [];
        vm.currentPage = 1;
        vm.pageSize = 50;
